...
public class AddStudent extends JFrame implements ActionListener {
    ...
    AddStudent(){
        ...
        lblrollno.setBounds(50,140,150,20);
        lblrollno.setFont(new Font("serifs",Font.ITALIC,20));
        add(lblrollno);

        labelrollno = new JLabel("5057"+ first4);
        labelrollno.setBounds(170,138,100,25);
        labelrollno.setFont(new Font("serifs",Font.ITALIC,20));
        add(labelrollno);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            try{
                String query = "insert into student values('"+name+"','"+fname+"','"+rollno+"','"+address+"','"+dob+"','"+phone+"','"+email+"','"+ClassX+"','"+classXII+"','"+aadhar+"','"+course+"','"+branch+"')";
